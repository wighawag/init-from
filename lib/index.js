...
dots.templateSettings = {
	...
	varname: 'it, utils', // ['it', 'utils'], // does not seem to work
	strip: false,
	append: true,
	selfcontained: false,
};
	...
	.then(file => {
		...
		gittar
			...
			.then(() => {
				...
				// TODO why cannot I pass the utils varname ?
				// for now use underscore convention for utils
				variables._firstToUpperCase = utils.firstToUpperCase;
				variables._firstToLowerCase = utils.firstToLowerCase;
